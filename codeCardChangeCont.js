...
<div class="text-used-code-cont">
  ...
  <div class="project-information-details-cont">
    <p class="project-details">
      Menu selection and accompanying modals for modifying a user's order. An interactive order cart that presents selected menu items, modifications, and total per item. Tip and tax calculators accurately display price totals during checkout. 
    </p>
  </div>
</div>
